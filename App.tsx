...
import { Phone, Menu, Mail, MapPin, ArrowRight, ArrowLeft, CheckCircle2, X, Calculator, HardHat, Sparkles, Building2, ShieldCheck, BadgeCheck, Ruler, Home as HomeIcon, Hammer, Users, Zap } from 'lucide-react';
    ...
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 text-white/60 max-w-md text-[11px] tracking-widest leading-loose uppercase">
            Setting the standard in construction excellence. Precision, Integrity, and Structural Perfection.
          </p>

          <div className="flex flex-wrap gap-3 mt-8">
            <div className="flex items-center space-x-2 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5">
              <ShieldCheck size={16} className="text-dm-red shrink-0" />
              <span className="text-[10px] font-bold uppercase tracking-widest text-white/80">NCA Registered</span>
            </div>
            <div className="flex items-center space-x-2 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5">
              <BadgeCheck size={16} className="text-dm-red shrink-0" />
              <span className="text-[10px] font-bold uppercase tracking-widest text-white/80">NEMA Compliant</span>
            </div>
          </div>
        </div>

        <div className="md:col-span-3 md:col-start-8">
          <h5 className="font-black text-[10px] tracking-widest mb-6 uppercase text-dm-red flex items-center space-x-2">
            <MapPin size={12} />
            <span>Office</span>
          </h5>
          <p className="text-white/70 text-[11px] uppercase tracking-widest leading-relaxed">
            {BUSINESS_INFO.pobox}<br />{BUSINESS_INFO.location}
          </p>
        </div>
        ...
        <div className="md:col-span-3">
          ...
          <a
            ...
            className="text-white/70 text-[11px] uppercase tracking-widest hover:text-white transition-colors break-all"
          >
            {BUSINESS_INFO.email}
          </a>
        </div>
      ...
      <div className="pt-8 border-t border-white/10 text-[9px] uppercase tracking-widest text-white/30 flex flex-col sm:flex-row gap-4 justify-between items-center text-center sm:text-left">
        <span>© {new Date().getFullYear()} D.M. Building Works. All rights reserved.</span>
